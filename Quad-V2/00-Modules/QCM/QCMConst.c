...
//------------------------------------------------------------
float const		_PID_ThrottleNoFly	= 0.35;
//------------------------------------------------------------
...
// PID parameters
//============================================================
float const		_PID_Roll_Kp		= 0.420;
float const		_PID_Roll_Kd		= 0.070;
//============================================================
float const		_PID_Pitch_Kp		= 0.420;
float const		_PID_Pitch_Kd		= 0.070;
//============================================================
