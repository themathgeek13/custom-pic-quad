...
const	byte		_MPU_Addr		= 0xD0; 	// 1101000-R/W ADO=0
//const	byte		_MPU_Addr		= 0xD2; 	// 1101001-R/W ADO=1
...
// function (converted to rad/sec)
	 	float		_MPU_Gyro_Sensitivity	= 0.0;
//------------------------------------------------------------------
...
// Accl Sensitivity: Calculated based upon AS parameter of RESET
	 	float		_MPU_Accl_Sensitivity	= 0.0;
...
//------------------------------------------------------------------
		I2CSubscr	_MPUSubscr = {&_MPUCallBack, &_MPUIntCtrl};
