...
//==================================================================================
pDCM	DCMMultiply(DCM* pLeft, DCM* pRight, DCM* pResult)
	{
...
//=============================================================
pVector	DCMToEarth(DCM* pBase, Vector* pV, Vector* pRes)
	{
	//--------------------------------------------------
	...
	//	Ze	= ZEarth * InBody
	//--------------------------------------------------
	pRes->X	= pBase->Rxx*pV->X + pBase->Rxy*pV->Y + pBase->Rxz*pV->Z;
	pRes->Y	= pBase->Ryx*pV->X + pBase->Ryy*pV->Y + pBase->Ryz*pV->Z;
	pRes->Z	= pBase->Rzx*pV->X + pBase->Rzy*pV->Y + pBase->Rzz*pV->Z;
	//---------------------------------------------------------------
	return pRes;
	}
//=============================================================
pVector	DCMToBody(DCM* pBase, Vector* pV, Vector* pRes)
	{
	//--------------------------------------------------
	...
	//	Zb	= InEarth * ZBody
	//--------------------------------------------------
	pRes->X	= pV->X*pBase->Rxx + pV->Y*pBase->Ryx + pV->Z*pBase->Rzx;
	pRes->Y	= pV->X*pBase->Rxy + pV->Y*pBase->Ryy + pV->Z*pBase->Rzy;
	pRes->Z	= pV->X*pBase->Rxz + pV->Y*pBase->Ryz + pV->Z*pBase->Rzz;
	//---------------------------------------------------------------
	return pRes;
	}
//=============================================================
...
//==================================================================================
pDCM	DCMNormalize(DCM* pBase, DCM* pNorm)
	{
	float	Error	= 0;
	//======================================
