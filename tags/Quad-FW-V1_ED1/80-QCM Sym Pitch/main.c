...
*/
		...
		//----------------------
		TM.MParam		= IMU.Pitch;
		TM.SetPoint		= RC.Pitch;
		TM.Error		= QSD.PitchError;
		TM.Omega		= QSD.PitchPVDer;							
		//----------------------
		TM.Prop			= QSD.DeltaPitchProp;		// Prop(.)
		TM.Diff			= QSD.DeltaPitchDiff;		// Diff(.)
		TM.Int			= QSD.DeltaPitchInt;		// Int(.)
		TM.MB			= QSD.DeltaPitchMB;			// MB(.)
		//----------------------
		TM.Total		= QSD.DeltaPitch;			// Tot(.)
		//----------------------
		TM.ErrSum		= QSD.PitchErrorSum;		// Err. Sum
		//----------------------
