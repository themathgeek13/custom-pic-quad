...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/14-MPLI2C-Sync.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../00-COMMON/BLI/BLI.c ../00-COMMON/BLI/BLIInit.c ../00-COMMON/BLI/BLILocal.c ../00-COMMON/BLI/BLIMorse.c ../00-COMMON/I2C/I2C_Async.c ../00-COMMON/I2C/I2C_Init.c ../00-COMMON/I2C/I2C_ISR.c ../00-COMMON/I2C/I2C_Local.c ../00-COMMON/I2C/I2C_Sync.c ../00-COMMON/I2C/I2C_SyncRead.c ../00-COMMON/I2C/I2C_SyncWrite.c ../00-COMMON/MPL/MPL_Async.c ../00-COMMON/MPL/MPL_Init.c ../00-COMMON/MPL/MPL_ISR.c ../00-COMMON/MPL/MPL_Local.c ../00-COMMON/MPL/MPL_Mgmt.c ../00-COMMON/MPL/MPL_Sync.c ../00-COMMON/SDL/SDL_API.c ../00-COMMON/SDL/SDL_Init.c ../00-COMMON/SDL/SDL_ISR.c ../00-COMMON/SDL/SDL_Local.c ../00-COMMON/TMR/TMR.c ../00-COMMON/TMR/TMRInit.c ../00-COMMON/TMR/TMRLocal.c ../00-COMMON/TMR/TMR_ISR.c main.c ../00-COMMON/Init/Init.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/554684679/BLI.o ${OBJECTDIR}/_ext/554684679/BLIInit.o ${OBJECTDIR}/_ext/554684679/BLILocal.o ${OBJECTDIR}/_ext/554684679/BLIMorse.o ${OBJECTDIR}/_ext/554678764/I2C_Async.o ${OBJECTDIR}/_ext/554678764/I2C_Init.o ${OBJECTDIR}/_ext/554678764/I2C_ISR.o ${OBJECTDIR}/_ext/554678764/I2C_Local.o ${OBJECTDIR}/_ext/554678764/I2C_Sync.o ${OBJECTDIR}/_ext/554678764/I2C_SyncRead.o ${OBJECTDIR}/_ext/554678764/I2C_SyncWrite.o ${OBJECTDIR}/_ext/554673981/MPL_Async.o ${OBJECTDIR}/_ext/554673981/MPL_Init.o ${OBJECTDIR}/_ext/554673981/MPL_ISR.o ${OBJECTDIR}/_ext/554673981/MPL_Local.o ${OBJECTDIR}/_ext/554673981/MPL_Mgmt.o ${OBJECTDIR}/_ext/554673981/MPL_Sync.o ${OBJECTDIR}/_ext/554668587/SDL_API.o ${OBJECTDIR}/_ext/554668587/SDL_Init.o ${OBJECTDIR}/_ext/554668587/SDL_ISR.o ${OBJECTDIR}/_ext/554668587/SDL_Local.o ${OBJECTDIR}/_ext/554667341/TMR.o ${OBJECTDIR}/_ext/554667341/TMRInit.o ${OBJECTDIR}/_ext/554667341/TMRLocal.o ${OBJECTDIR}/_ext/554667341/TMR_ISR.o ${OBJECTDIR}/main.o ${OBJECTDIR}/_ext/15113546/Init.o
...
# Source Files
SOURCEFILES=../00-COMMON/BLI/BLI.c ../00-COMMON/BLI/BLIInit.c ../00-COMMON/BLI/BLILocal.c ../00-COMMON/BLI/BLIMorse.c ../00-COMMON/I2C/I2C_Async.c ../00-COMMON/I2C/I2C_Init.c ../00-COMMON/I2C/I2C_ISR.c ../00-COMMON/I2C/I2C_Local.c ../00-COMMON/I2C/I2C_Sync.c ../00-COMMON/I2C/I2C_SyncRead.c ../00-COMMON/I2C/I2C_SyncWrite.c ../00-COMMON/MPL/MPL_Async.c ../00-COMMON/MPL/MPL_Init.c ../00-COMMON/MPL/MPL_ISR.c ../00-COMMON/MPL/MPL_Local.c ../00-COMMON/MPL/MPL_Mgmt.c ../00-COMMON/MPL/MPL_Sync.c ../00-COMMON/SDL/SDL_API.c ../00-COMMON/SDL/SDL_Init.c ../00-COMMON/SDL/SDL_ISR.c ../00-COMMON/SDL/SDL_Local.c ../00-COMMON/TMR/TMR.c ../00-COMMON/TMR/TMRInit.c ../00-COMMON/TMR/TMRLocal.c ../00-COMMON/TMR/TMR_ISR.c main.c ../00-COMMON/Init/Init.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/14-MPLI2C-Sync.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/14-MPLI2C-Sync.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/14-MPLI2C-Sync.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/14-MPLI2C-Sync.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/14-MPLI2C-Sync.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/14-MPLI2C-Sync.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
